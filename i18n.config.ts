export default defineI18nConfig(() => ({
  ...
  messages: {
    de: {
      ...
      msg: "Die Edition der Filmmusik von Erich Wolfgang Korngold bildet einen zentralen Bestandteil der dem Komponisten gewidmeten Werkausgabe ({website}). Verbunden damit sind Herausforderungen der Multimedialität, die den Anlass für eine interdisziplinäre Erkundung des Themenkomplexes bieten.",
